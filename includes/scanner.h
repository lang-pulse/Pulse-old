...
typedef enum {
  ...
  TOKEN_MINUS, TOKEN_NEWLINE, TOKEN_SEMICOLON, TOKEN_POWER,
  TOKEN_PLUS, TOKEN_SLASH, TOKEN_STAR, //16

  // One or two character tokens.
  TOKEN_BANG, TOKEN_BANG_EQUAL,
  TOKEN_EQUAL, TOKEN_EQUAL_EQUAL,
  TOKEN_GREATER, TOKEN_GREATER_EQUAL,
  TOKEN_LESS, TOKEN_LESS_EQUAL, //24

  // Literals.
  TOKEN_IDENTIFIER, TOKEN_STRING, TOKEN_NUMBER, //27
